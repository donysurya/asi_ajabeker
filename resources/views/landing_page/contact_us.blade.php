...
@section('container')
    ...
    <div class="container py-3">
        <div class="row py-5 gx-5 d-flex justify-content-center align-items-center">
            ...
            <div class="col-md-5 bg-light shadow-lg px-5 py-4" style="border-radius:1rem !important;">
