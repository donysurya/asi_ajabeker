...
@section('title', 'Visi & Misi - ASI AJABEKER')
    ...
    <div class="container mt-5 pt-5">
        <div class="row d-flex justify-content-center">
            <div class="col-md-9 position-relative bg-primary" style="border-radius:1rem;">
                ...
                <h3 class="text-white p-4">Visi & Misi</h3>
            </div>
        </div>
    </div>
            ...
            <div class="row d-flex justify-content-center align-items-center pt-5">
                ...
                <div class="col-md-5">
                    ...
                    <div id="accordion">
                        ...
                        <div class="card mb-4">
                            <a class="card-link btn btn-primary p-3 d-flex justify-content-between" data-toggle="collapse" href="#visi" aria-expanded="false" aria-controls="visi">
                                Visi
                ...
                <div class="col-md-5">
                    ...
                    <div id="accordion">
                        ...
                        <div class="card mb-4">
                            <a class="card-link btn btn-primary p-3 d-flex justify-content-between" data-toggle="collapse" href="#misi" aria-expanded="false" aria-controls="misi">
                                Misi
                                <span class="collapsed"><i class="fa fa-plus-circle"></i></span> 
                                <span class="expanded"><i class="fa fa-minus-circle"></i></span> 
                            </a>
